...
class pMOS(val wPower: Input, val wIn: Input, val wOut: Output, threshold: Double) extends Component with PrimitiveActive with PowerInput with SingleInput with SingleOutput {
